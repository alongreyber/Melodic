...
func (client *Client) User(params UserWhereUniqueInput) *UserExec {
	ret := client.Client.GetOne(
		...
		"user",
		[]string{"id", "spotifyId", "accessToken"})
...
const (
	...
	UserOrderByInputAccessTokenAsc  UserOrderByInput = "accessToken_ASC"
	UserOrderByInputAccessTokenDesc UserOrderByInput = "accessToken_DESC"
)
